...
public final class Licence {
    ...
    public static void setCatalogProductSettings(CatalogProductSettings settings) {
        if (settings == null) {
            global_008290A0 = "";
            global_008290A4 = 0L;
            global_008290A8 = 0L;
        ...
        global_008290A0 = settings;
        global_008290A4 = settings.teleportProductId();
        global_008290A8 = settings.moodlightProductId();
        global_00829078 = settings.packages();
        global_0082907C = settings.petPackages();
        global_00829084 = settings.clubProductRows();
        refreshCatalogProductSettings();
    }

    public static void setTeleportProductId(long productId) {
        useCatalogProductComponentMirrors();
    ...
    private static void useCatalogProductComponentMirrors() {
        if (global_008290A0 instanceof CatalogProductSettings settings) {
            global_008290A0 = settings.counterProducts();
        }
    }

    private static void refreshCatalogProductSettings() {
        if (global_008290A0 instanceof CatalogProductSettings settings) {
            CatalogState.instance().setProductSettings(settings);
            return;
        }
